  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex items-center group">
      ...
      <a
        ...
        className="relative flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-tr from-emerald-600 to-teal-500 text-white rounded-full shadow-xl shadow-emerald-500/30 hover:scale-110 active:scale-95 transition-all duration-300 hover:shadow-emerald-500/50"
      >
        <svg
