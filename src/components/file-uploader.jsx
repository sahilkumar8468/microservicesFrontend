    ...
    <div>
      ...
      >
        <div className="flex flex-col items-center gap-2">
          ...
          <div>
            <span className="text-brand-600 font-semibold text-sm">{label}</span>
            <span className="text-surface-500 text-sm"> or drag and drop</span>
          </div>
          ...
          {files.map((file, i) => (
            <div key={i} className="relative group rounded-lg overflow-hidden bg-surface-100 aspect-square">
              ...
              <button
                ...
                className="absolute top-1 right-1 w-6 h-6 bg-surface-900/70 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
